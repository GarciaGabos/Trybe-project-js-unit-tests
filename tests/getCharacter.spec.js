...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Teste se a função para Arya', () => {
  ...
  it('Teste se a função para Brienne', () => {
  ...
  it('Teste se a função Melissandre', () => {
  ...
  it('Teste se ao passar um nome que não está na tabela, a função retorna undefined.', () => {
    expect(getCharacter('Barney')).toBeUndefined();
  });
  
  it('Teste case senstitive', () => {
