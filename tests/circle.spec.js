...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('circulo retorna undefined caso o parâmetro não seja número', () => {
    expect(circle('z')).toBeUndefined();
  });

  it('circulo retorna um objeto', () => {
    expect(typeof circle(4)).toEqual('object');
  });

  it('circulo retorna objeto de 3 propriedades', () => {
    expect(Object.keys(circle(4)).length).toEqual(3);
  });

  it('circulo retorna undefined quando n tem parametro', () => {
    expect(circle()).toBeUndefined();
  });

  it('circunferencia correta para circulo de raio 2', () => {
    expect(Object.values(circle(2))[2]).toEqual(12.56);
  });
 
  it('area correta para circulo de raio 3', () => {
